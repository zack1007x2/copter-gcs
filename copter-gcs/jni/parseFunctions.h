...
jobject unpack_msg_boot(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_boot_t inp;
	mavlink_msg_boot_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(boot_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(boot_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(boot_class, "version", "J");
	env->SetLongField (result, fid, (long) inp.version);

	
	fid = env->GetFieldID(boot_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(boot_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_boot(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
...
jobject unpack_msg_system_time(JNIEnv *env, mavlink_message_t& message){
	...
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(system_time_class, "time_usec", "J");
...
jobject unpack_msg_ping(JNIEnv *env, mavlink_message_t& message){
	...
	fid = env->GetFieldID(ping_class, "time", "J");
...
jobject unpack_msg_system_time_utc(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_system_time_utc_t inp;
	mavlink_msg_system_time_utc_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(system_time_utc_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(system_time_utc_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(system_time_utc_class, "utc_date", "J");
	env->SetLongField (result, fid, (long) inp.utc_date);

	fid = env->GetFieldID(system_time_utc_class, "utc_time", "J");
	env->SetLongField (result, fid, (long) inp.utc_time);

	
	fid = env->GetFieldID(system_time_utc_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(system_time_utc_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_system_time_utc(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint32_t utc_date = (uint32_t)env->GetLongField (obj, env->GetFieldID(system_time_utc_class, "utc_date", "J"));
...
jobject unpack_msg_action_ack(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_action_ack_t inp;
	mavlink_msg_action_ack_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(action_ack_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(action_ack_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(action_ack_class, "action", "I");
	env->SetIntField (result, fid, (int) inp.action);

	fid = env->GetFieldID(action_ack_class, "result", "I");
	env->SetIntField (result, fid, (int) inp.result);

	
	fid = env->GetFieldID(action_ack_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(action_ack_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_action_ack(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t action = (uint8_t)env->GetIntField (obj, env->GetFieldID(action_ack_class, "action", "I"));
...
jobject unpack_msg_action(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_action_t inp;
	mavlink_msg_action_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(action_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(action_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(action_class, "target", "I");
	env->SetIntField (result, fid, (int) inp.target);

	fid = env->GetFieldID(action_class, "target_component", "I");
	env->SetIntField (result, fid, (int) inp.target_component);

	fid = env->GetFieldID(action_class, "action", "I");
	env->SetIntField (result, fid, (int) inp.action);

	
	fid = env->GetFieldID(action_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(action_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_action(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t target = (uint8_t)env->GetIntField (obj, env->GetFieldID(action_class, "target", "I"));
	uint8_t target_component = (uint8_t)env->GetIntField (obj, env->GetFieldID(action_class, "target_component", "I"));
...
jobject unpack_msg_set_mode(JNIEnv *env, mavlink_message_t& message){
	...
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(set_mode_class, "target", "I");
	env->SetIntField (result, fid, (int) inp.target);

	fid = env->GetFieldID(set_mode_class, "mode", "I");
...
void pack_msg_set_mode(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t target = (uint8_t)env->GetIntField (obj, env->GetFieldID(set_mode_class, "target", "I"));
...
jobject unpack_msg_set_nav_mode(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_set_nav_mode_t inp;
	mavlink_msg_set_nav_mode_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(set_nav_mode_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(set_nav_mode_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(set_nav_mode_class, "target", "I");
	env->SetIntField (result, fid, (int) inp.target);

	fid = env->GetFieldID(set_nav_mode_class, "nav_mode", "I");
	env->SetIntField (result, fid, (int) inp.nav_mode);

	
	fid = env->GetFieldID(set_nav_mode_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(set_nav_mode_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_set_nav_mode(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t target = (uint8_t)env->GetIntField (obj, env->GetFieldID(set_nav_mode_class, "target", "I"));
...
jobject unpack_msg_param_request_read(JNIEnv *env, mavlink_message_t& message){
...

	{
		...
		fid = env->GetFieldID(param_request_read_class, "param_id", "[I");
...
jobject unpack_msg_param_value(JNIEnv *env, mavlink_message_t& message){
	...
	{
		// Lets send it onto Java.
		fid = env->GetFieldID(param_value_class, "param_id", "[I");
		jintArray intArr = (jintArray) env->GetObjectField(result, fid);
		jint* data = env->GetIntArrayElements(intArr, NULL);
		for(int i = 0; i < 15; i++)
			data[i] = inp.param_id[i];
...
jobject unpack_msg_param_set(JNIEnv *env, mavlink_message_t& message){
	...
	{
		// Lets send it onto Java.
		fid = env->GetFieldID(param_set_class, "param_id", "[I");
		jintArray intArr = (jintArray) env->GetObjectField(result, fid);
		jint* data = env->GetIntArrayElements(intArr, NULL);
		for(int i = 0; i < 15; i++)
			data[i] = inp.param_id[i];
...
jobject unpack_msg_gps_raw_int(JNIEnv *env, mavlink_message_t& message){
	...
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(gps_raw_int_class, "usec", "J");
	...
	fid = env->GetFieldID(gps_raw_int_class, "eph", "F");
	env->SetFloatField (result, fid, (float)inp.eph);

	fid = env->GetFieldID(gps_raw_int_class, "epv", "F");
	env->SetFloatField (result, fid, (float)inp.epv);

	fid = env->GetFieldID(gps_raw_int_class, "v", "F");
	env->SetFloatField (result, fid, (float)inp.v);

	fid = env->GetFieldID(gps_raw_int_class, "hdg", "F");
	env->SetFloatField (result, fid, (float)inp.hdg);
...
void pack_msg_gps_raw_int(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint64_t usec = (uint64_t)env->GetLongField (obj, env->GetFieldID(gps_raw_int_class, "usec", "J"));
	...
	float eph = (float)env->GetFloatField (obj, env->GetFieldID(gps_raw_int_class, "eph", "F"));
	float epv = (float)env->GetFloatField (obj, env->GetFieldID(gps_raw_int_class, "epv", "F"));
	float v = (float)env->GetFloatField (obj, env->GetFieldID(gps_raw_int_class, "v", "F"));
...
jobject unpack_msg_scaled_imu(JNIEnv *env, mavlink_message_t& message){
	...
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(scaled_imu_class, "usec", "J");
	env->SetLongField (result, fid, (long) inp.usec);
...
void pack_msg_scaled_imu(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint64_t usec = (uint64_t)env->GetLongField (obj, env->GetFieldID(scaled_imu_class, "usec", "J"));
...
jobject unpack_msg_raw_imu(JNIEnv *env, mavlink_message_t& message){
	...
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(raw_imu_class, "usec", "J");
	env->SetLongField (result, fid, (long) inp.usec);
...
void pack_msg_raw_imu(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint64_t usec = (uint64_t)env->GetLongField (obj, env->GetFieldID(raw_imu_class, "usec", "J"));
...
jobject unpack_msg_raw_pressure(JNIEnv *env, mavlink_message_t& message){
	...
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(raw_pressure_class, "usec", "J");
	env->SetLongField (result, fid, (long) inp.usec);
...
void pack_msg_raw_pressure(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint64_t usec = (uint64_t)env->GetLongField (obj, env->GetFieldID(raw_pressure_class, "usec", "J"));
...
jobject unpack_msg_scaled_pressure(JNIEnv *env, mavlink_message_t& message){
	...
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(scaled_pressure_class, "usec", "J");
	env->SetLongField (result, fid, (long) inp.usec);
...
void pack_msg_scaled_pressure(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint64_t usec = (uint64_t)env->GetLongField (obj, env->GetFieldID(scaled_pressure_class, "usec", "J"));
...
jobject unpack_msg_attitude(JNIEnv *env, mavlink_message_t& message){
	...
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(attitude_class, "usec", "J");
	env->SetLongField (result, fid, (long) inp.usec);
...
void pack_msg_attitude(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint64_t usec = (uint64_t)env->GetLongField (obj, env->GetFieldID(attitude_class, "usec", "J"));
...
jobject unpack_msg_local_position(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_local_position_t inp;
	mavlink_msg_local_position_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(local_position_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(local_position_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(local_position_class, "usec", "J");
	env->SetLongField (result, fid, (long) inp.usec);

	fid = env->GetFieldID(local_position_class, "x", "F");
	env->SetFloatField (result, fid, (float)inp.x);

	fid = env->GetFieldID(local_position_class, "y", "F");
	env->SetFloatField (result, fid, (float)inp.y);

	fid = env->GetFieldID(local_position_class, "z", "F");
	env->SetFloatField (result, fid, (float)inp.z);

	fid = env->GetFieldID(local_position_class, "vx", "F");
	env->SetFloatField (result, fid, (float)inp.vx);

	fid = env->GetFieldID(local_position_class, "vy", "F");
	env->SetFloatField (result, fid, (float)inp.vy);

	fid = env->GetFieldID(local_position_class, "vz", "F");
	env->SetFloatField (result, fid, (float)inp.vz);

	
	fid = env->GetFieldID(local_position_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(local_position_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_local_position(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint64_t usec = (uint64_t)env->GetLongField (obj, env->GetFieldID(local_position_class, "usec", "J"));
	float x = (float)env->GetFloatField (obj, env->GetFieldID(local_position_class, "x", "F"));
	float y = (float)env->GetFloatField (obj, env->GetFieldID(local_position_class, "y", "F"));
	float z = (float)env->GetFloatField (obj, env->GetFieldID(local_position_class, "z", "F"));
	float vx = (float)env->GetFloatField (obj, env->GetFieldID(local_position_class, "vx", "F"));
	float vy = (float)env->GetFloatField (obj, env->GetFieldID(local_position_class, "vy", "F"));
...
jobject unpack_msg_global_position(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_global_position_t inp;
	mavlink_msg_global_position_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(global_position_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(global_position_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(global_position_class, "usec", "J");
	env->SetLongField (result, fid, (long) inp.usec);

	fid = env->GetFieldID(global_position_class, "lat", "F");
	env->SetFloatField (result, fid, (float)inp.lat);

	fid = env->GetFieldID(global_position_class, "lon", "F");
	env->SetFloatField (result, fid, (float)inp.lon);

	fid = env->GetFieldID(global_position_class, "alt", "F");
	env->SetFloatField (result, fid, (float)inp.alt);

	fid = env->GetFieldID(global_position_class, "vx", "F");
	env->SetFloatField (result, fid, (float)inp.vx);

	fid = env->GetFieldID(global_position_class, "vy", "F");
	env->SetFloatField (result, fid, (float)inp.vy);

	fid = env->GetFieldID(global_position_class, "vz", "F");
	env->SetFloatField (result, fid, (float)inp.vz);

	
	fid = env->GetFieldID(global_position_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(global_position_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_global_position(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint64_t usec = (uint64_t)env->GetLongField (obj, env->GetFieldID(global_position_class, "usec", "J"));
	float lat = (float)env->GetFloatField (obj, env->GetFieldID(global_position_class, "lat", "F"));
	float lon = (float)env->GetFloatField (obj, env->GetFieldID(global_position_class, "lon", "F"));
	float alt = (float)env->GetFloatField (obj, env->GetFieldID(global_position_class, "alt", "F"));
	float vx = (float)env->GetFloatField (obj, env->GetFieldID(global_position_class, "vx", "F"));
	float vy = (float)env->GetFloatField (obj, env->GetFieldID(global_position_class, "vy", "F"));
...
jobject unpack_msg_gps_raw(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_gps_raw_t inp;
	mavlink_msg_gps_raw_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(gps_raw_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(gps_raw_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(gps_raw_class, "usec", "J");
	env->SetLongField (result, fid, (long) inp.usec);

	fid = env->GetFieldID(gps_raw_class, "fix_type", "I");
	env->SetIntField (result, fid, (int) inp.fix_type);

	fid = env->GetFieldID(gps_raw_class, "lat", "F");
	env->SetFloatField (result, fid, (float)inp.lat);

	fid = env->GetFieldID(gps_raw_class, "lon", "F");
	env->SetFloatField (result, fid, (float)inp.lon);

	fid = env->GetFieldID(gps_raw_class, "alt", "F");
	env->SetFloatField (result, fid, (float)inp.alt);

	fid = env->GetFieldID(gps_raw_class, "eph", "F");
	env->SetFloatField (result, fid, (float)inp.eph);

	fid = env->GetFieldID(gps_raw_class, "epv", "F");
	env->SetFloatField (result, fid, (float)inp.epv);

	fid = env->GetFieldID(gps_raw_class, "v", "F");
	env->SetFloatField (result, fid, (float)inp.v);

	fid = env->GetFieldID(gps_raw_class, "hdg", "F");
	env->SetFloatField (result, fid, (float)inp.hdg);

	
	fid = env->GetFieldID(gps_raw_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(gps_raw_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_gps_raw(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint64_t usec = (uint64_t)env->GetLongField (obj, env->GetFieldID(gps_raw_class, "usec", "J"));
	uint8_t fix_type = (uint8_t)env->GetIntField (obj, env->GetFieldID(gps_raw_class, "fix_type", "I"));
	float lat = (float)env->GetFloatField (obj, env->GetFieldID(gps_raw_class, "lat", "F"));
	float lon = (float)env->GetFloatField (obj, env->GetFieldID(gps_raw_class, "lon", "F"));
	float alt = (float)env->GetFloatField (obj, env->GetFieldID(gps_raw_class, "alt", "F"));
	float eph = (float)env->GetFloatField (obj, env->GetFieldID(gps_raw_class, "eph", "F"));
	float epv = (float)env->GetFloatField (obj, env->GetFieldID(gps_raw_class, "epv", "F"));
	float v = (float)env->GetFloatField (obj, env->GetFieldID(gps_raw_class, "v", "F"));
...
jobject unpack_msg_sys_status(JNIEnv *env, mavlink_message_t& message){
	...
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(sys_status_class, "mode", "I");
	env->SetIntField (result, fid, (int) inp.mode);

	fid = env->GetFieldID(sys_status_class, "nav_mode", "I");
	env->SetIntField (result, fid, (int) inp.nav_mode);

	fid = env->GetFieldID(sys_status_class, "status", "I");
	env->SetIntField (result, fid, (int) inp.status);

	fid = env->GetFieldID(sys_status_class, "load", "I");
	env->SetIntField (result, fid, (int) inp.load);

	fid = env->GetFieldID(sys_status_class, "vbat", "I");
	env->SetIntField (result, fid, (int) inp.vbat);

	fid = env->GetFieldID(sys_status_class, "battery_remaining", "I");
	env->SetIntField (result, fid, (int) inp.battery_remaining);

	fid = env->GetFieldID(sys_status_class, "packet_drop", "I");
	env->SetIntField (result, fid, (int) inp.packet_drop);
...
void pack_msg_sys_status(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t mode = (uint8_t)env->GetIntField (obj, env->GetFieldID(sys_status_class, "mode", "I"));
	uint8_t nav_mode = (uint8_t)env->GetIntField (obj, env->GetFieldID(sys_status_class, "nav_mode", "I"));
	uint8_t status = (uint8_t)env->GetIntField (obj, env->GetFieldID(sys_status_class, "status", "I"));
	uint16_t load = (uint16_t)env->GetIntField (obj, env->GetFieldID(sys_status_class, "load", "I"));
	uint16_t vbat = (uint16_t)env->GetIntField (obj, env->GetFieldID(sys_status_class, "vbat", "I"));
	uint16_t battery_remaining = (uint16_t)env->GetIntField (obj, env->GetFieldID(sys_status_class, "battery_remaining", "I"));
...
jobject unpack_msg_waypoint(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_waypoint_t inp;
	mavlink_msg_waypoint_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(waypoint_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(waypoint_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(waypoint_class, "target_system", "I");
	env->SetIntField (result, fid, (int) inp.target_system);

	fid = env->GetFieldID(waypoint_class, "target_component", "I");
	env->SetIntField (result, fid, (int) inp.target_component);

	fid = env->GetFieldID(waypoint_class, "seq", "I");
	env->SetIntField (result, fid, (int) inp.seq);

	fid = env->GetFieldID(waypoint_class, "frame", "I");
	env->SetIntField (result, fid, (int) inp.frame);

	fid = env->GetFieldID(waypoint_class, "command", "I");
	env->SetIntField (result, fid, (int) inp.command);

	fid = env->GetFieldID(waypoint_class, "current", "I");
	env->SetIntField (result, fid, (int) inp.current);

	fid = env->GetFieldID(waypoint_class, "autocontinue", "I");
	env->SetIntField (result, fid, (int) inp.autocontinue);

	fid = env->GetFieldID(waypoint_class, "param1", "F");
	env->SetFloatField (result, fid, (float)inp.param1);

	fid = env->GetFieldID(waypoint_class, "param2", "F");
	env->SetFloatField (result, fid, (float)inp.param2);

	fid = env->GetFieldID(waypoint_class, "param3", "F");
	env->SetFloatField (result, fid, (float)inp.param3);

	fid = env->GetFieldID(waypoint_class, "param4", "F");
	env->SetFloatField (result, fid, (float)inp.param4);

	fid = env->GetFieldID(waypoint_class, "x", "F");
	env->SetFloatField (result, fid, (float)inp.x);

	fid = env->GetFieldID(waypoint_class, "y", "F");
	env->SetFloatField (result, fid, (float)inp.y);

	fid = env->GetFieldID(waypoint_class, "z", "F");
	env->SetFloatField (result, fid, (float)inp.z);

	
	fid = env->GetFieldID(waypoint_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(waypoint_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_waypoint(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t target_system = (uint8_t)env->GetIntField (obj, env->GetFieldID(waypoint_class, "target_system", "I"));
	uint8_t target_component = (uint8_t)env->GetIntField (obj, env->GetFieldID(waypoint_class, "target_component", "I"));
	uint16_t seq = (uint16_t)env->GetIntField (obj, env->GetFieldID(waypoint_class, "seq", "I"));
	uint8_t frame = (uint8_t)env->GetIntField (obj, env->GetFieldID(waypoint_class, "frame", "I"));
	uint8_t command = (uint8_t)env->GetIntField (obj, env->GetFieldID(waypoint_class, "command", "I"));
	uint8_t current = (uint8_t)env->GetIntField (obj, env->GetFieldID(waypoint_class, "current", "I"));
	uint8_t autocontinue = (uint8_t)env->GetIntField (obj, env->GetFieldID(waypoint_class, "autocontinue", "I"));
	float param1 = (float)env->GetFloatField (obj, env->GetFieldID(waypoint_class, "param1", "F"));
	float param2 = (float)env->GetFloatField (obj, env->GetFieldID(waypoint_class, "param2", "F"));
	float param3 = (float)env->GetFloatField (obj, env->GetFieldID(waypoint_class, "param3", "F"));
	float param4 = (float)env->GetFloatField (obj, env->GetFieldID(waypoint_class, "param4", "F"));
	float x = (float)env->GetFloatField (obj, env->GetFieldID(waypoint_class, "x", "F"));
	float y = (float)env->GetFloatField (obj, env->GetFieldID(waypoint_class, "y", "F"));
...
jobject unpack_msg_waypoint_request(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_waypoint_request_t inp;
	mavlink_msg_waypoint_request_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(waypoint_request_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(waypoint_request_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(waypoint_request_class, "target_system", "I");
	env->SetIntField (result, fid, (int) inp.target_system);

	fid = env->GetFieldID(waypoint_request_class, "target_component", "I");
	env->SetIntField (result, fid, (int) inp.target_component);

	fid = env->GetFieldID(waypoint_request_class, "seq", "I");
	env->SetIntField (result, fid, (int) inp.seq);

	
	fid = env->GetFieldID(waypoint_request_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(waypoint_request_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_waypoint_request(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t target_system = (uint8_t)env->GetIntField (obj, env->GetFieldID(waypoint_request_class, "target_system", "I"));
	uint8_t target_component = (uint8_t)env->GetIntField (obj, env->GetFieldID(waypoint_request_class, "target_component", "I"));
...
jobject unpack_msg_waypoint_set_current(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_waypoint_set_current_t inp;
	mavlink_msg_waypoint_set_current_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(waypoint_set_current_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(waypoint_set_current_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(waypoint_set_current_class, "target_system", "I");
	env->SetIntField (result, fid, (int) inp.target_system);

	fid = env->GetFieldID(waypoint_set_current_class, "target_component", "I");
	env->SetIntField (result, fid, (int) inp.target_component);

	fid = env->GetFieldID(waypoint_set_current_class, "seq", "I");
	env->SetIntField (result, fid, (int) inp.seq);

	
	fid = env->GetFieldID(waypoint_set_current_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(waypoint_set_current_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_waypoint_set_current(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t target_system = (uint8_t)env->GetIntField (obj, env->GetFieldID(waypoint_set_current_class, "target_system", "I"));
	uint8_t target_component = (uint8_t)env->GetIntField (obj, env->GetFieldID(waypoint_set_current_class, "target_component", "I"));
...
jobject unpack_msg_waypoint_current(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_waypoint_current_t inp;
	mavlink_msg_waypoint_current_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(waypoint_current_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(waypoint_current_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(waypoint_current_class, "seq", "I");
	env->SetIntField (result, fid, (int) inp.seq);

	
	fid = env->GetFieldID(waypoint_current_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(waypoint_current_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_waypoint_current(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
...
jobject unpack_msg_waypoint_request_list(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_waypoint_request_list_t inp;
	mavlink_msg_waypoint_request_list_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(waypoint_request_list_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(waypoint_request_list_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(waypoint_request_list_class, "target_system", "I");
	env->SetIntField (result, fid, (int) inp.target_system);

	fid = env->GetFieldID(waypoint_request_list_class, "target_component", "I");
	env->SetIntField (result, fid, (int) inp.target_component);

	
	fid = env->GetFieldID(waypoint_request_list_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(waypoint_request_list_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_waypoint_request_list(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t target_system = (uint8_t)env->GetIntField (obj, env->GetFieldID(waypoint_request_list_class, "target_system", "I"));
...
jobject unpack_msg_waypoint_count(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_waypoint_count_t inp;
	mavlink_msg_waypoint_count_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(waypoint_count_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(waypoint_count_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(waypoint_count_class, "target_system", "I");
	env->SetIntField (result, fid, (int) inp.target_system);

	fid = env->GetFieldID(waypoint_count_class, "target_component", "I");
	env->SetIntField (result, fid, (int) inp.target_component);

	fid = env->GetFieldID(waypoint_count_class, "count", "I");
	env->SetIntField (result, fid, (int) inp.count);

	
	fid = env->GetFieldID(waypoint_count_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(waypoint_count_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_waypoint_count(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t target_system = (uint8_t)env->GetIntField (obj, env->GetFieldID(waypoint_count_class, "target_system", "I"));
	uint8_t target_component = (uint8_t)env->GetIntField (obj, env->GetFieldID(waypoint_count_class, "target_component", "I"));
...
jobject unpack_msg_waypoint_clear_all(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_waypoint_clear_all_t inp;
	mavlink_msg_waypoint_clear_all_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(waypoint_clear_all_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(waypoint_clear_all_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(waypoint_clear_all_class, "target_system", "I");
	env->SetIntField (result, fid, (int) inp.target_system);

	fid = env->GetFieldID(waypoint_clear_all_class, "target_component", "I");
	env->SetIntField (result, fid, (int) inp.target_component);

	
	fid = env->GetFieldID(waypoint_clear_all_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(waypoint_clear_all_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_waypoint_clear_all(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t target_system = (uint8_t)env->GetIntField (obj, env->GetFieldID(waypoint_clear_all_class, "target_system", "I"));
...
jobject unpack_msg_waypoint_reached(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_waypoint_reached_t inp;
	mavlink_msg_waypoint_reached_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(waypoint_reached_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(waypoint_reached_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(waypoint_reached_class, "seq", "I");
	env->SetIntField (result, fid, (int) inp.seq);

	
	fid = env->GetFieldID(waypoint_reached_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(waypoint_reached_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_waypoint_reached(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
...
jobject unpack_msg_waypoint_ack(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_waypoint_ack_t inp;
	mavlink_msg_waypoint_ack_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(waypoint_ack_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(waypoint_ack_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(waypoint_ack_class, "target_system", "I");
	env->SetIntField (result, fid, (int) inp.target_system);

	fid = env->GetFieldID(waypoint_ack_class, "target_component", "I");
	env->SetIntField (result, fid, (int) inp.target_component);

	fid = env->GetFieldID(waypoint_ack_class, "type", "I");
	env->SetIntField (result, fid, (int) inp.type);

	
	fid = env->GetFieldID(waypoint_ack_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(waypoint_ack_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_waypoint_ack(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t target_system = (uint8_t)env->GetIntField (obj, env->GetFieldID(waypoint_ack_class, "target_system", "I"));
	uint8_t target_component = (uint8_t)env->GetIntField (obj, env->GetFieldID(waypoint_ack_class, "target_component", "I"));
...
jobject unpack_msg_gps_set_global_origin(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_gps_set_global_origin_t inp;
	mavlink_msg_gps_set_global_origin_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(gps_set_global_origin_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(gps_set_global_origin_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(gps_set_global_origin_class, "target_system", "I");
	env->SetIntField (result, fid, (int) inp.target_system);

	fid = env->GetFieldID(gps_set_global_origin_class, "target_component", "I");
	env->SetIntField (result, fid, (int) inp.target_component);

	fid = env->GetFieldID(gps_set_global_origin_class, "latitude", "J");
	env->SetLongField (result, fid, (long) inp.latitude);

	fid = env->GetFieldID(gps_set_global_origin_class, "longitude", "J");
	env->SetLongField (result, fid, (long) inp.longitude);

	fid = env->GetFieldID(gps_set_global_origin_class, "altitude", "J");
	env->SetLongField (result, fid, (long) inp.altitude);

	
	fid = env->GetFieldID(gps_set_global_origin_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(gps_set_global_origin_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_gps_set_global_origin(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t target_system = (uint8_t)env->GetIntField (obj, env->GetFieldID(gps_set_global_origin_class, "target_system", "I"));
	uint8_t target_component = (uint8_t)env->GetIntField (obj, env->GetFieldID(gps_set_global_origin_class, "target_component", "I"));
	int32_t latitude = (int32_t)env->GetLongField (obj, env->GetFieldID(gps_set_global_origin_class, "latitude", "J"));
	int32_t longitude = (int32_t)env->GetLongField (obj, env->GetFieldID(gps_set_global_origin_class, "longitude", "J"));
...
jobject unpack_msg_gps_local_origin_set(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_gps_local_origin_set_t inp;
	mavlink_msg_gps_local_origin_set_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(gps_local_origin_set_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(gps_local_origin_set_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(gps_local_origin_set_class, "latitude", "J");
	env->SetLongField (result, fid, (long) inp.latitude);

	fid = env->GetFieldID(gps_local_origin_set_class, "longitude", "J");
	env->SetLongField (result, fid, (long) inp.longitude);

	fid = env->GetFieldID(gps_local_origin_set_class, "altitude", "J");
	env->SetLongField (result, fid, (long) inp.altitude);

	
	fid = env->GetFieldID(gps_local_origin_set_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(gps_local_origin_set_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_gps_local_origin_set(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	int32_t latitude = (int32_t)env->GetLongField (obj, env->GetFieldID(gps_local_origin_set_class, "latitude", "J"));
	int32_t longitude = (int32_t)env->GetLongField (obj, env->GetFieldID(gps_local_origin_set_class, "longitude", "J"));
...
jobject unpack_msg_local_position_setpoint_set(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_local_position_setpoint_set_t inp;
	mavlink_msg_local_position_setpoint_set_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(local_position_setpoint_set_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(local_position_setpoint_set_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(local_position_setpoint_set_class, "target_system", "I");
	env->SetIntField (result, fid, (int) inp.target_system);

	fid = env->GetFieldID(local_position_setpoint_set_class, "target_component", "I");
	env->SetIntField (result, fid, (int) inp.target_component);

	fid = env->GetFieldID(local_position_setpoint_set_class, "x", "F");
	env->SetFloatField (result, fid, (float)inp.x);

	fid = env->GetFieldID(local_position_setpoint_set_class, "y", "F");
	env->SetFloatField (result, fid, (float)inp.y);

	fid = env->GetFieldID(local_position_setpoint_set_class, "z", "F");
	env->SetFloatField (result, fid, (float)inp.z);

	fid = env->GetFieldID(local_position_setpoint_set_class, "yaw", "F");
	env->SetFloatField (result, fid, (float)inp.yaw);

	
	fid = env->GetFieldID(local_position_setpoint_set_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(local_position_setpoint_set_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_local_position_setpoint_set(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t target_system = (uint8_t)env->GetIntField (obj, env->GetFieldID(local_position_setpoint_set_class, "target_system", "I"));
	uint8_t target_component = (uint8_t)env->GetIntField (obj, env->GetFieldID(local_position_setpoint_set_class, "target_component", "I"));
	float x = (float)env->GetFloatField (obj, env->GetFieldID(local_position_setpoint_set_class, "x", "F"));
	float y = (float)env->GetFloatField (obj, env->GetFieldID(local_position_setpoint_set_class, "y", "F"));
	float z = (float)env->GetFloatField (obj, env->GetFieldID(local_position_setpoint_set_class, "z", "F"));
...
jobject unpack_msg_control_status(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_control_status_t inp;
	mavlink_msg_control_status_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(control_status_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(control_status_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(control_status_class, "position_fix", "I");
	env->SetIntField (result, fid, (int) inp.position_fix);

	fid = env->GetFieldID(control_status_class, "vision_fix", "I");
	env->SetIntField (result, fid, (int) inp.vision_fix);

	fid = env->GetFieldID(control_status_class, "gps_fix", "I");
	env->SetIntField (result, fid, (int) inp.gps_fix);

	fid = env->GetFieldID(control_status_class, "ahrs_health", "I");
	env->SetIntField (result, fid, (int) inp.ahrs_health);

	fid = env->GetFieldID(control_status_class, "control_att", "I");
	env->SetIntField (result, fid, (int) inp.control_att);

	fid = env->GetFieldID(control_status_class, "control_pos_xy", "I");
	env->SetIntField (result, fid, (int) inp.control_pos_xy);

	fid = env->GetFieldID(control_status_class, "control_pos_z", "I");
	env->SetIntField (result, fid, (int) inp.control_pos_z);

	fid = env->GetFieldID(control_status_class, "control_pos_yaw", "I");
	env->SetIntField (result, fid, (int) inp.control_pos_yaw);

	
	fid = env->GetFieldID(control_status_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(control_status_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_control_status(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t position_fix = (uint8_t)env->GetIntField (obj, env->GetFieldID(control_status_class, "position_fix", "I"));
	uint8_t vision_fix = (uint8_t)env->GetIntField (obj, env->GetFieldID(control_status_class, "vision_fix", "I"));
	uint8_t gps_fix = (uint8_t)env->GetIntField (obj, env->GetFieldID(control_status_class, "gps_fix", "I"));
	uint8_t ahrs_health = (uint8_t)env->GetIntField (obj, env->GetFieldID(control_status_class, "ahrs_health", "I"));
	uint8_t control_att = (uint8_t)env->GetIntField (obj, env->GetFieldID(control_status_class, "control_att", "I"));
	uint8_t control_pos_xy = (uint8_t)env->GetIntField (obj, env->GetFieldID(control_status_class, "control_pos_xy", "I"));
	uint8_t control_pos_z = (uint8_t)env->GetIntField (obj, env->GetFieldID(control_status_class, "control_pos_z", "I"));
...
jobject unpack_msg_position_target(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_position_target_t inp;
	mavlink_msg_position_target_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(position_target_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(position_target_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(position_target_class, "x", "F");
	env->SetFloatField (result, fid, (float)inp.x);

	fid = env->GetFieldID(position_target_class, "y", "F");
	env->SetFloatField (result, fid, (float)inp.y);

	fid = env->GetFieldID(position_target_class, "z", "F");
	env->SetFloatField (result, fid, (float)inp.z);

	fid = env->GetFieldID(position_target_class, "yaw", "F");
	env->SetFloatField (result, fid, (float)inp.yaw);

	
	fid = env->GetFieldID(position_target_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(position_target_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_position_target(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	float x = (float)env->GetFloatField (obj, env->GetFieldID(position_target_class, "x", "F"));
	float y = (float)env->GetFloatField (obj, env->GetFieldID(position_target_class, "y", "F"));
	float z = (float)env->GetFloatField (obj, env->GetFieldID(position_target_class, "z", "F"));
...
jobject unpack_msg_set_altitude(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_set_altitude_t inp;
	mavlink_msg_set_altitude_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(set_altitude_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(set_altitude_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(set_altitude_class, "target", "I");
	env->SetIntField (result, fid, (int) inp.target);

	fid = env->GetFieldID(set_altitude_class, "mode", "J");
	env->SetLongField (result, fid, (long) inp.mode);

	
	fid = env->GetFieldID(set_altitude_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(set_altitude_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_set_altitude(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t target = (uint8_t)env->GetIntField (obj, env->GetFieldID(set_altitude_class, "target", "I"));
...
jobject unpack_msg_hil_state(JNIEnv *env, mavlink_message_t& message){
	...
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(hil_state_class, "usec", "J");
	env->SetLongField (result, fid, (long) inp.usec);
...
void pack_msg_hil_state(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint64_t usec = (uint64_t)env->GetLongField (obj, env->GetFieldID(hil_state_class, "usec", "J"));
...
jobject unpack_msg_hil_controls(JNIEnv *env, mavlink_message_t& message){
	...
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(hil_controls_class, "time_us", "J");
	env->SetLongField (result, fid, (long) inp.time_us);
...
void pack_msg_hil_controls(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint64_t time_us = (uint64_t)env->GetLongField (obj, env->GetFieldID(hil_controls_class, "time_us", "J"));
...
jobject unpack_msg_command(JNIEnv *env, mavlink_message_t& message){
	
	jclass newMessage;
	mavlink_command_t inp;
	mavlink_msg_command_decode(&message, &inp);
	
	// Create the object
	jmethodID cid = env->GetMethodID(command_class, "<init>", "()V");
	if (cid == NULL) return NULL; /* exception thrown */
	jobject result = env->NewObject(command_class, cid);
	
	
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(command_class, "target_system", "I");
	env->SetIntField (result, fid, (int) inp.target_system);

	fid = env->GetFieldID(command_class, "target_component", "I");
	env->SetIntField (result, fid, (int) inp.target_component);

	fid = env->GetFieldID(command_class, "command", "I");
	env->SetIntField (result, fid, (int) inp.command);

	fid = env->GetFieldID(command_class, "confirmation", "I");
	env->SetIntField (result, fid, (int) inp.confirmation);

	fid = env->GetFieldID(command_class, "param1", "F");
	env->SetFloatField (result, fid, (float)inp.param1);

	fid = env->GetFieldID(command_class, "param2", "F");
	env->SetFloatField (result, fid, (float)inp.param2);

	fid = env->GetFieldID(command_class, "param3", "F");
	env->SetFloatField (result, fid, (float)inp.param3);

	fid = env->GetFieldID(command_class, "param4", "F");
	env->SetFloatField (result, fid, (float)inp.param4);

	
	fid = env->GetFieldID(command_class, "sysID", "I");
	env->SetIntField (result, fid, (int) message.sysid);
	fid = env->GetFieldID(command_class, "componentID", "I");
	env->SetIntField (result, fid, (int) message.compid);
	/* Free local references */
	//env->DeleteLocalRef(heartbeatClass);
...
void pack_msg_command(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	uint8_t target_system = (uint8_t)env->GetIntField (obj, env->GetFieldID(command_class, "target_system", "I"));
	uint8_t target_component = (uint8_t)env->GetIntField (obj, env->GetFieldID(command_class, "target_component", "I"));
	uint8_t command = (uint8_t)env->GetIntField (obj, env->GetFieldID(command_class, "command", "I"));
	uint8_t confirmation = (uint8_t)env->GetIntField (obj, env->GetFieldID(command_class, "confirmation", "I"));
	float param1 = (float)env->GetFloatField (obj, env->GetFieldID(command_class, "param1", "F"));
	float param2 = (float)env->GetFloatField (obj, env->GetFieldID(command_class, "param2", "F"));
	float param3 = (float)env->GetFloatField (obj, env->GetFieldID(command_class, "param3", "F"));
...
jobject unpack_msg_command_ack(JNIEnv *env, mavlink_message_t& message){
	...
	//Set values
	jfieldID fid;
	fid = env->GetFieldID(command_ack_class, "command", "F");
	env->SetFloatField (result, fid, (float)inp.command);

	fid = env->GetFieldID(command_ack_class, "result", "F");
	env->SetFloatField (result, fid, (float)inp.result);
...
void pack_msg_command_ack(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	float command = (float)env->GetFloatField (obj, env->GetFieldID(command_ack_class, "command", "F"));
...
jobject unpack_msg_debug_vect(JNIEnv *env, mavlink_message_t& message){
	...
	fid = env->GetFieldID(debug_vect_class, "usec", "J");
	env->SetLongField (result, fid, (long) inp.usec);
...
void pack_msg_debug_vect(JNIEnv *env, jclass& classType, jobject& obj, mavlink_message_t& msg){
	...
	uint64_t usec = (uint64_t)env->GetLongField (obj, env->GetFieldID(debug_vect_class, "usec", "J"));
...
jobject unpack_msg_statustext(JNIEnv *env, mavlink_message_t& message){
	...
	{
		// Lets send it onto Java.
		fid = env->GetFieldID(statustext_class, "text", "[I");
		jintArray intArr = (jintArray) env->GetObjectField(result, fid);
		jint* data = env->GetIntArrayElements(intArr, NULL);
		for(int i = 0; i < 50; i++)
			data[i] = inp.text[i];
